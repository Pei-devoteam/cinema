...
<div id="mobileHeader">
	...
	<spring:url value="/resources/images/bosnia-mobile.png" var="imageBosnia" />
	<spring:url value="/resources/images/italia-mobile.png" var="imageItalia" />
	...
	<security:authorize access="isAnonymous()">
		<div id="login">
			<form name="loginForm" action="${loginUrl}" method="post">
				...
				<a href="${urlRegister}">${labelRegister}</a>
			</form>
			<div class="languages">
