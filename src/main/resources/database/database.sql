...
insert into movie(name,release_date,description,image,trailer_url,actors,director) values ('Fight Club','2015-07-10',' An insomniac office worker, looking for a way to change his life, crosses paths with a devil-may-care soap maker, forming an underground fight club that evolves into something much, much more...',file_read('src/main/resources/database/images/fight.jpeg'),'https://www.youtube.com/watch?v=SUXWAEX2jlg','Edward Norton, Brad Pitt, Helena Bonham Carter, Meat Loaf','David Fincher');
insert into movie(name,release_date,description,image,trailer_url,actors,director) values ('Minions','2015-07-02','Minions Stuart, Kevin and Bob are recruited by Scarlet Overkill, a super-villain who, alongside her inventor husband Herb, hatches a plot to take over the world.',file_read('src/main/resources/database/images/minions.jpeg'),'https://www.youtube.com/watch?v=eisKxhjBnZ0','Sandra Bullock, Allison Janney, Jon Hamm, Michael Keaton','Kyle Balda, Pierre Coffin');
insert into movie(name,release_date,description,image,trailer_url,actors,director) values ('Home','2015-02-02','When Oh, a loveable misfit from another planet, lands on Earth and finds himself on the run from his own people, he forms an unlikely friendship with an adventurous girl named Tip who is on a quest of her own. Through a series of comic adventures with Tip, Oh comes to understand that being different and making mistakes is all part of being human. And while he changes her planet and she changes his world, they discover the true meaning of the word HOME. ',file_read('src/main/resources/database/images/home.jpg'),'https://www.youtube.com/watch?v=iLGDJkhYnVc','Jim Parsons, Rihanna, Steve Martin, Jennifer Lopez','Tim Johnson');
insert into movie(name,release_date,description,image,trailer_url,actors,director) values ('Once Upon a Time in America','1984-09-23','A former Prohibition-era Jewish gangster returns to the Lower East Side of Manhattan over thirty years later, where he once again must confront the ghosts and regrets of his old life.',file_read('src/main/resources/database/images/once.jpg'),'https://www.youtube.com/watch?v=mzhX2PD6Srw','Robert De Niro, James Woods, Elizabeth McGovern, Joe Pesci','Sergio Leone');
insert into movie(name,release_date,description,image,trailer_url,actors,director) values ('Taken 3','2015-01-21','Ex-government operative Bryan Mills is accused of a ruthless murder he never committed or witnessed. As he is tracked and pursued, Mills brings out his particular set of skills to find the true killer and clear his name.',file_read('src/main/resources/database/images/taken.jpg'),'https://www.youtube.com/watch?v=HUJZjUaNzgw','Liam Neeson, Forest Whitaker, Famke Janssen, Maggie Grace','Olivier Megaton');
insert into movie(name,release_date,description,image,trailer_url,actors,director) values ('X-Men: Days of Future Past','2014-05-22','The X-Men send Wolverine to the past in a desperate effort to change history and prevent an event that results in doom for both humans and mutants.',file_read('src/main/resources/database/images/x-men.jpg'),'https://www.youtube.com/watch?v=pK2zYHWDZKo','Hugh Jackman, James McAvoy, Michael Fassbender, Jennifer Lawrence','Bryan Singer');
insert into movie(name,release_date,description,image,trailer_url,actors,director) values ('Fifty Shades of Grey','2015-02-13','Literature student Anastasia Steele''s life changes forever when she meets handsome, yet tormented, billionaire Christian Grey.',file_read('src/main/resources/database/images/50.jpg'),'https://www.youtube.com/watch?v=CQERFnGvi_A','Dakota Johnson, Jamie Dornan, Jennifer Ehle, Eloise Mumford','Sam Taylor-Johnson');
insert into movie(name,release_date,description,image,trailer_url,actors,director) values ('Jupiter Ascending','2015-02-06','A young woman discovers her destiny as an heiress of intergalactic nobility and must fight to protect the inhabitants of Earth from an ancient and destructive industry.',file_read('src/main/resources/database/images/jupiter.jpg'),'https://www.youtube.com/watch?v=t4ZzMkDLjWI','Mila Kunis, Channing Tatum, Sean Bean, Eddie Redmayne','Andy Wachowski, Lana Wachowski');
insert into movie(name,release_date,description,image,trailer_url,actors,director) values ('Braveheart','1995-05-24','When his secret bride is executed for assaulting an English soldier who tried to rape her, William Wallace begins a revolt and leads Scottish warriors against the cruel English tyrant who rules Scotland with an iron fist.',file_read('src/main/resources/database/images/brave.jpg'),'https://www.youtube.com/watch?v=wj0I8xVTV18','Mel Gibson,James Robinson, Sean Lawlor, Sandy Nelson, James Cosmo','Mel Gibson');
